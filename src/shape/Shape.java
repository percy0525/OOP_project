...
public class Shape {
    ...
    public void paintPort(Graphics g){
        g.fillRect((int)this.xy.getX() + (int)(this.widthHeight.getWidth()/2), (int)this.xy.getY()-5, PORT_WIDTH, PORT_HEIGHT);
        g.fillRect((int)this.xy.getX()-5, (int)(this.xy.getY() + this.widthHeight.getHeight()/2), PORT_WIDTH, PORT_HEIGHT);
        g.fillRect((int)(this.xy.getX() + this.widthHeight.getWidth()/2), (int)(this.xy.getY() + this.widthHeight.getHeight()-5), PORT_WIDTH, PORT_HEIGHT);
        g.fillRect((int)this.xy.getX() + (int)(this.widthHeight.getWidth())-5, (int)(this.xy.getY() + this.widthHeight.getHeight()/2), PORT_WIDTH, PORT_HEIGHT);
    }
